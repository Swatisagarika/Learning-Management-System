  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 mb-8 px-2">
        ...
        />
        {!collapsed && (
          <h1 className="text-xl font-bold tracking-wide text-gray-800 dark:text-gray-100">
            Admin Panel
          </h1>
        )}
      </div>
      ...
      <nav className="flex flex-col gap-2 text-sm font-medium">
        ...
        <SidebarItem
          ...
          collapsed={collapsed}
          active={location.pathname === "/eventmanagement"}
        />
        ...
        <SidebarDropdown
          ...
          icon={<FaCertificate />}
          collapsed={collapsed}
          open={openDropdown === "certificate"}
          toggle={() => toggleDropdown("certificate")}
          links={[
            { to: "/adminissuecertificate", label: "Issue Certificate" },
          ]}
          location={location}
        />
  ...
  <div className="w-full">
    <div
      ...
      className={`flex items-center justify-between px-3 py-2 rounded-lg cursor-pointer transition-colors
        ...
        hover:bg-[rgba(37,150,190,1)] hover:text-white
        ${open ? "bg-[rgba(37,150,190,1)] text-white" : ""}`}
    >
    ...
    {open && !collapsed && (
      <div className="ml-8 mt-1 space-y-1 border-l border-gray-300 dark:border-gray-600 pl-3">
        {links.map((link) => (
          <Link
            key={link.to}
            to={link.to}
            className={`block px-2 py-1 rounded transition-all
              ${
                location.pathname === link.to
                  ? "bg-[rgba(37,150,190,1)] text-white"
                  : "text-gray-600 dark:text-gray-300 hover:bg-[rgba(37,150,190,1)] hover:text-white"
              }`}
          >
            {link.label}
          </Link>
