        ...
        <div className="p-4 md:p-6 lg:p-8">
          <div className="flex justify-between items-center mb-6 flex-wrap gap-4">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-[rgba(37,150,190,1)] text-white rounded hover:bg-[#093c4f] transition text-sm"
            >
              <FaPlus /> Add Holiday
            </button>
          </div>
          ...
          <div className="overflow-x-auto bg-white shadow rounded-lg">
            <table className="min-w-full text-sm text-gray-700">
              <thead className="bg-[rgba(37,150,190,1)] text-white text-left">
                <tr>
