          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-[rgba(37,150,190,1)]"
            ...
            <div className="flex justify-end gap-3 mt-4">
              ...
              <button
                type="submit"
                className="px-4 py-2 bg-[rgba(37,150,190,1)] text-white hover:bg-[rgba(37,150,190,1)] rounded"
              >
