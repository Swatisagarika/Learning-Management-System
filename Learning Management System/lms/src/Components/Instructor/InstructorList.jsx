      ...
      <div className="flex-1 ml-20 md:ml-64">
        ...
        <div className="p-4">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-bold text-purple-800">Instructor List</h2>
            <div className="flex flex-wrap gap-2 items-center">
              ...
              <button
                className={`px-4 py-2 rounded text-white text-sm ${view === "list" ? "bg-purple-600" : "bg-gray-400"}`}
                onClick={() => setView("list")}
              >
                List View
              </button>
              <button
                className={`px-4 py-2 rounded text-white text-sm ${view === "grid" ? "bg-purple-600" : "bg-gray-400"}`}
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
              {paginatedData.map((prof, index) => (
                ...
                >
                  ...
                  />
                  <h3 className="font-semibold text-purple-800">{prof.instructorName}</h3>
          ...
          <div className="flex justify-end items-center gap-2 mt-6">
            <button
              ...
              className={`px-4 py-2 rounded ${
                currentPage === 1 ? "bg-gray-300 cursor-not-allowed" : "bg-purple-600 hover:bg-purple-700 text-white"
              }`}
            >
              Prev
            </button>
