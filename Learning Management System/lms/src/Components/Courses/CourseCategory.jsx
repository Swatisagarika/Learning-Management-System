      ...
      <div className="flex-1 ml-20 md:ml-64">
        ...
        <div className="p-4 max-w-2xl mx-auto">
          <div className="bg-white shadow-md rounded-lg p-6">
            <h2 className="text-2xl font-bold text-purple-800 mb-6">Course Categories</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-4">
              ...
              <button
                onClick={handleAdd}
                className="flex items-center justify-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded"
              >
                <FaPlus /> Add
              </button>
            </div>
