      ...
      <div className="bg-white w-full max-w-lg p-6 rounded shadow-lg relative">
        ...
        <div className="mb-4">
          ...
          <select
            ...
            className="w-full px-3 py-2 border rounded bg-white focus:ring-2 focus:ring-purple-500"
            defaultValue={
          ...
          {showCustomTitle && (
            <input
              ...
              className="mt-2 w-full px-3 py-2 border rounded focus:ring-2 focus:ring-purple-500"
            />
          )}
          {errors.title && (
        ...
        <div className="mb-4">
          ...
          <select
            ...
            onChange={handleChange}
            className="w-full px-4 py-2 border rounded bg-white focus:ring-2 focus:ring-purple-500"
          >
